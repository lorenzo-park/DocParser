...
from serving.config import InferenceConfig, INPUT_IMAGE, INPUT_IMAGE_META, INPUT_ANCHORS, OUTPUT_DETECTION, OUTPUT_MASK
...
class DocparserService(bentoml.BentoService):
    ...
    def predict(self, inputs):
        ...
        for idx, r in enumerate(results):
            ...
            outputs.append({'prediction_list': prediction_list, 'orig_img_shape': orig_shape})
        return outputs
