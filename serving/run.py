...
from serving.config import InferenceConfig, OUTPUT_DETECTION, OUTPUT_MASK
...
class DocparserService(bentoml.BentoService):
    ...
    def predict(self, inputs):
        ...
        pred = loaded_func(
            ...
            train_mode=tf.constant(False)
        )
        output = pred['prediction']

        preprocess_obj.result_to_dict(images, molded_images, windows, result)[0]
